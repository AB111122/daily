      ...
      <Box h="71px">
        <Box ml="230px" mr="230px">
          ...
          >
            ...
            >
              <h4>Web Version</h4>
              <Text fontSize="sm"> User Manual for Daily Vitals Web</Text>
            </GridItem>
            <GridItem
              w="100%"
              bg="white"
            ...
            >
              ...
              <Text fontSize="sm">
                {" "}
                User Manual for the Daily Vitals Mobile App
              </Text>
            </GridItem>
            <GridItem
              w="100%"
            ...
            >
              ...
              <Text fontSize="sm"> User Manual for Daily Vitals Pro</Text>
            </GridItem>
          </Grid>
          <br />
          <Box
          ...
          >
            <h4>FAQ</h4>
            <Text fontSize="sm"> Daily Vitals Frequently Asked Questions </Text>
          </Box>
        ...
        <Box ml="200px" mr="200px" mt="50px" pb="100px">
          <Text>Daily Vitals: Your Health Care Patner</Text>
        </Box>
      </Box>
    </div>
  );
