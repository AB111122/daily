  ...
  return (
    <>
      ...
      <Container maxW="100%" h="auto" bg="white" pb="100px">
        ...
        >
          Daily Vitals is the most accurate, comprehensive nutrition tracking app
        ...
        <Text
          ...
          fontSize={["md", "md", "lg", "lg"]}
        >
          Our CEO, Abdul Basit, built Daily Vitals as a side project in 2025. He
          ...
          decided to build an app to track his diet. Thus, Daily Vitals was born.
        ...
        <Text
          ...
          fontSize={["md", "md", "lg", "lg"]}
        >
          Daily Vitals's success has hinged entirely on positive word-of-mouth
        ...
        <Text
          ...
          fontSize={["md", "md", "lg", "lg"]}
        >
          While our staff spans the globe our headquarters is based in Karachi, Pakistan. Karachi is a
          health-centric mountain city Providing endless options for staying
        ...
        <Text
          ...
          fontSize={["md", "md", "lg", "lg"]}
        >
          Our goal is to build the best Website for individuals and professionals to
