        ...
        >
          <VStack w={["90%", "85%%", "45%"]}>
            ...
            <Text>
              ...
              Daily Vitals web lets you easily track your nutrition, helping you
        ...
        >
          <GridItem className={styles.gridItems}>
            ...
            <Text
              ...
              mt="20px"
            >
              Mastering Diabetes with Daily Vitals
            </Text>
          ...
          <GridItem className={styles.gridItems}>
            ...
            <Text fontSize={["m", "lg", "xl"]} fontWeight={"extrabold"}>
              Our New Look: The Details Behind Daily Vitals Makeover
            </Text>
          ...
          <GridItem className={styles.gridItems}>
            ...
            />
            <Text fontSize={["m", "lg", "xl"]} fontWeight={"extrabold"}>
              New & Improved: The Latest Daily Vitals Updates
            </Text>
            <Text>November 14, 2022</Text>
          </GridItem>
      ...
      <Box padding={"100px 0px"}>
        ...
        >
          <Box W={["95%", "55%", "35%"]}>
            ...
            <Text fontSize={["s", "m", "l"]}>
              Get up to date on all of the latest Daily Vitals updates, including
        ...
        >
          <Box w={["60%", "60%", "40%"]}>
            ...
            <Text color="white" fontSize={["m", "l", "xl"]} fontWeight="medium">
              Track your foods, exercise, and health data with the Daily Vitals
              web.
            </Text>
          </Box>
        ...
        >
          <Flex w="46%" flexDirection={"column"} justifyContent="center">
            <Text fontSize={["xl", "2xl", "3xl"]} fontWeight="bold">
              Track your food, exercise and health metrics with the Daily Vitals
              app.
            </Text>
            <br />
            <Button
