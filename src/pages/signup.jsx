  ...
  return (
    <>
      <HStack bgColor={"#262a3b"} h={"90px"}>
        <Link href="/">
          <Image ml={"40px"} h={"70px"} src="images.png"></Image>
        </Link>
      </HStack>
      <Box
        bgImage={
              ...
              >
                ...
                >
                  ...
                  <Box px={5} py={2}>
                    ...
                    >
                      {" "}
                      I agree to the DailyVitals{" "}
                      <Text as={"span"} color={"red"}>
                        Terms of Service
                      </Text>
                    </Checkbox>
                    <Text fontWeight={"medium"}>
                      In order to give you the best experience using Daily Vitals,
                       we need certain data permissions. (These are optional
